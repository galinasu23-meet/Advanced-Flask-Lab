...
user_bio = "galina's page :O "

posts = {
    "https://i.insider.com/61d1c0e2aa741500193b2d18?width=1136&format=jpeg": "2021 cohort's Y3 Accelerator!",
...
def home():
    return render_template('index.html', img= image_link, bio = user_bio, postss= posts)
